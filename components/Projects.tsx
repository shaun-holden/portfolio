...
const projects = [
  ...
  },
  {
    ...
    description:
      "Multi-department finance platform with subscription tiers, budget vs. actual comparisons, company health scoring, economic indicators via FRED API, and Stripe billing.",
    tech: ["React", "TypeScript", "Vite", "Express", "PostgreSQL", "Drizzle", "Stripe", "Recharts", "Tailwind CSS"],
    liveUrl: "#",
    githubUrl: "https://github.com/shaun-holden/monthly-contribution-finance-tracker",
  ...
  },
  {
    ...
    title: "SubCoach Pro",
    description:
      "Platform connecting gym owners with certified substitute fitness coaches. Features job posting, applications, scheduling, subscription billing, and real-time analytics.",
    tech: ["React", "TypeScript", "Vite", "Express", "PostgreSQL", "Drizzle", "Stripe", "SendGrid", "Tailwind CSS"],
    liveUrl: "#",
    githubUrl: "#",
    image: "/projects/subcoach-pro.png",
  ...
  {
    id: 11,
    title: "Inbound Gymnastics",
    description:
      "Professional website for a gymnastics studio with filterable class listings, seasonal camps, birthday party packages, competitive team showcase, and calendar event integration.",
    tech: ["Next.js", "React", "TypeScript", "Framer Motion", "Tailwind CSS"],
    liveUrl: "#",
    githubUrl: "#",
    image: "/projects/inbound-gymnastics.png",
  ...
  },
  {
    ...
    description:
      "Online quoting tool for smart property hardware and installation services with real-time pricing calculations, professional PDF generation, and email delivery to clients.",
    tech: ["Next.js", "React", "TypeScript", "React PDF", "Nodemailer", "Tailwind CSS"],
    liveUrl: "#",
    githubUrl: "#",
    image: "/projects/smart-quote.png",
  ...
  },
  {
    ...
    title: "GymPlan Pro",
    description:
      "Gymnastics lesson planning tool for coaches to build, save, share, and print lesson plans. Includes a skill library, custom skill banks, session timers, and group/individual modes.",
    tech: ["React", "JavaScript", "CSS", "localStorage"],
    liveUrl: "#",
    githubUrl: "#",
    image: "/projects/gymplan-pro.png",
  ...
  },
  {
    ...
    description:
      "Feature-rich calculator with scientific functions, expression history, keyboard support, and a custom recursive math parser that safely evaluates expressions without eval().",
